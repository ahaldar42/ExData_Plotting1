# This R code generates the first plot of the Project 1: plot1.R
...
# Generating Plot 1
# Generating the first Plot - Histogram for Global Active Power
hist(Subset_df$Global_active_power, col="red",
